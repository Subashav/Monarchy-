...
export const legalContent = {
    ...
    terms: {
        ...
        content: `
            <div class="legal-section">
                <h3>1. Terms</h3>
                <p>By accessing the website at <a href="https://monarchy.company">monarchy.company</a>, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site.</p>
            </div>
            <div class="legal-section">
                <h3>2. Use License</h3>
